...
const Dashboard = () => {
  ...
  const fetchFoodDetails = async () => {
    try {
      ...
      const response1 = await axios.get("https://rescue-bite-server-hf2las26n-amols-projects-604b6fbf.vercel.app/provider_id", {
        headers: {
      ...
      const response = await axios.get(
        "https://rescue-bite-server-hf2las26n-amols-projects-604b6fbf.vercel.app/provider_history_curr",
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
            ...
            <div className="user-dashboard">
              ...
              <div className="row gx-5">
                {foodDetails.map((detail) => (
                  <div
                    className="col-md-7 col-sm-7 col-xs-12 gutter"
                    key={detail.food_id}
                  >
                    <div className="sales">
                      ...
                      <h2>
                        Time of posting:{" "}
                        {new Date(detail.request_time).toLocaleString()}
                      </h2>
                    </div>
                  </div>
                ))}
